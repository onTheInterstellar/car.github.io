...
public class UserConstants
{
    ...
    /** 岗位编码是否唯一的返回结果码 */
    public final static String CUSTOMER_PHONE_UNIQUE = "0";
    public final static String CUSTOMER_PHONE_NOT_UNIQUE = "1";

    /** 岗位编码是否唯一的返回结果码 */
    public final static String CUSTOMER_NAME_UNIQUE = "0";
    public final static String CUSTOMER_NAME_NOT_UNIQUE = "1";
